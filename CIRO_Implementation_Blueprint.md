...
```
. (Workspace Root)
├── signal_layer/                  # Signal Layer (FastAPI Mock Server)
...
│   └── .env
│
├── intelligence_layer/            # Intelligence Layer (Google Antigravity Pipeline)
...
│
├── presentation_layer/            # Presentation Layer (Flutter Mobile App)
│   ├── lib/
│   │   ├── main.dart
